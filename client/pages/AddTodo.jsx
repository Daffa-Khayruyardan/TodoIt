    ...
    return(
        <div className="xl:flex xl:justify-center xl:items-center xl:bg-silverLight xl:flex-1">
            ...
            <form action="" className="xl:shadow-md xl:bg-white xl:w-96 xl:h-64">
                ...
                {/* input field */}
                <input type="text" placeholder="Title"  className="xl:h-10 xl:pl-4 xl:rounded xl:ml-[1.9em] xl:mt-[1em] xl:w-[82%] xl:input xl:bg-greenLightDying xl:focus:outline-none" />
                ...
                <div className="xl:flex xl:justify-between xl:ml-8 xl:mr-10 xl:items-center xl:mt-[1.4em]">
                    ...
                    {/* button yes */}
                    <button type="submit" className="xl:border xl:px-4 xl:py-2 xl:rounded xl:text-white xl:bg-greenLight xl:border-greenLight">
                        Add
                    </button>
                </div>
            </form>
